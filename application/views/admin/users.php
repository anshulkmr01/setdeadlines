	...
	<div class="container-fluid table categories-table">
		<div class="container">
			...
			<table id="myTable" class="sortable-table">
				<?= form_open('admin/AdminController/deleteSelectedUser'); ?>
				...
				<tr>
					...
					<td><center><?php
							if($user->is_verified == 0){
								...
								?></center></td>
						<td>
							<?= anchor("admin/AdminController/userProfile/{$user->id}",'Login',['class'=>'btn btn-primary']); ?>
						</td>
						<td>
							<?= anchor("admin/AdminController/deleteUser/{$user->id}",'Delete',['class'=>'delete btn btn-danger']); ?>
						</td>
